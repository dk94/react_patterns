...
class Toggle extends React.Component {
  ...
  static On = (props) => <div>{props.on && props.children}</div>;
  static Off = (props) => <div>{!props.on && props.children}</div>;
  static Button = (props) => <Switch onClick={props.toggle} on={props.on}/>;
